...
SECRET_KEY = 'django-insecure-eb3ckd))%f$lp7hjem#9ofk)4j=c8*4g^rs7grmxv@&aaao5ez'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'myblog',  # Your PostgreSQL database name
    ...
    'mysql': {
        ...
        'NAME': 'daniel_blog',  # Your PostgreSQL database name
